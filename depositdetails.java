...
ResultSet res = null;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Deposit Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Deposit Table", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        setSize(new java.awt.Dimension(827, 584));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
   // be sure that user enter the date
     ...
     JOptionPane.showMessageDialog(null,"Complete Your Information","Missing Information",2);
        ...
        try{ //get deposits from database that happen in that day
          String sql = "select * from deposit where DATE='"+day.getSelectedItem()+"-"+month.getSelectedItem()+"-"+year.getSelectedItem()+"' ";  
          con=Connect.connect(); //connect to database
          pre=con.prepareStatement(sql);//prepared sql statement
          res=pre.executeQuery(); // get result
          depositdetails.setModel(DbUtils.resultSetToTableModel(res)); // put result in table
          Connect.close(con); // close connect
          }catch(Exception e){
